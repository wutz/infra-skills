...
| 方案 | 服务器台数 | 纠删码 | SSD配置 | 可用容量 | 读带宽 | 写带宽 | 读IOPS | 写IOPS |
|------|-----------|--------|---------|----------|--------|--------|--------|--------|
| **方案1 ⭐** | 5台 | EC8+2P | 24×15.36TB | 1.18 PiB | 259.73 GB/s | 111.62 GB/s | 1,125,000 | 1,125,000 |
| 方案2 | 9台 | EC8+2P | 24×7.68TB | 1.06 PiB | 444.06 GB/s | 200.91 GB/s | 2,025,000 | 2,025,000 |
| 方案3 | 17台 | EC8+2P | 24×3.84TB | 1.00 PiB | 750.22 GB/s | 379.49 GB/s | 3,825,000 | 3,825,000 |
| 方案4 | 34台 | EC8+2P | 24×1.92TB | 1.00 PiB | 1323.01 GB/s | 758.99 GB/s | 7,650,000 | 7,650,000 |
