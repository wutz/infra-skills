...
脚本会输出 Markdown 格式的规划报告，包含：
- 需求摘要
- EBox 硬件方案（如果选择）
- CNode+DBox 硬件方案（如果选择）
...
| 磁盘规格 | EBox数 | 可用容量 | 裸容量 | 读带宽 | 持续写带宽 | 峰值写带宽 | 读 IOPS | 写 IOPS |
|---------|-------|--------|-------|-------|---------|---------|--------|--------|
| 15.36TB | 11 | 982.67 TB | 1.32 PB (1351.68 TB) | 231 GB/s | 28.6 GB/s | 110 GB/s | 1980K | 261.25K |
| 30.72TB | 11 | 1.92 PB (1965.34 TB) | 2.64 PB (2703.36 TB) | 231 GB/s | 28.6 GB/s | 110 GB/s | 1980K | 261.25K |
| 61.44TB | 11 | 3.36 PB (3439.35 TB) | 4.62 PB (4730.88 TB) | 231 GB/s | 28.6 GB/s | 110 GB/s | 1980K | 261.25K |
...
|-----|--------|-------|-------|---------|---------|--------|--------|-----|
| 3 CNode (1U-1N-GEN5-2NIC) + 1 DBox (Ceres DF-3060-V2, 61.44TB盘) | 982.62 TB | 1.32 PB (1351.68 TB) | 58 GB/s | 8.5 GB/s | 20 GB/s | 585K | 100K | 使用 60TB 的硬盘，单 DBox 就可以达到 1 PB 的容量，具有极高的性价比 |
| 4 CNode (1U-1N-GEN5-2NIC) + 2 DBox (Ceres DF-3015-V2, 15.36TB盘) | 552.73 TB | 675.84 TB | 116 GB/s | 14.8 GB/s | 40 GB/s | 780K | 180K |  |
| 5 CNode (1U-1N-GEN6-2NIC) + 2 DBox (MLK DF-5630, 30.72TB盘) | 2.29 PB (2340.00 TB) | 2.64 PB (2703.36 TB) | 112 GB/s | 21.2 GB/s | 60 GB/s | 1100K | 200K | 2PB |
```
